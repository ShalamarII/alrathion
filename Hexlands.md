The Hexlands have some unique systems that are added onto the base game.
...
2. Roll against the Complexity Dice of that skill and get the highest number (6 on a d6).
3. Be applicable for the new Skill's Complexity Dice.
This allows you to gain a dice in that skill (starting at 1d6). When you hit the level of familiarity in that skill equal to the complexity die, you gain the skill wholesale and can now trade, sell or have it stolen.

When you have familiarity in a skill, you can use it for prerequisites. 
